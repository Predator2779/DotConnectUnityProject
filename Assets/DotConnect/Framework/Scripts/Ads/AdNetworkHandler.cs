...
namespace BizzyBeeGames
{
	public abstract class AdNetworkHandler
	{
		...
		public MobileAdsManager.AdEvent					OnBannerAdLoading		{ get; set; }
		public MobileAdsManager.AdEvent					OnBannerAdLoaded		{ get; set; }
		public MobileAdsManager.AdEvent					OnBannerAdFailedToLoad	{ get; set; }
		public MobileAdsManager.AdEvent					OnBannerAdShown			{ get; set; }
		public MobileAdsManager.AdEvent					OnBannerAdHidden		{ get; set; }

		public MobileAdsManager.AdEvent					OnInterstitialAdLoading			{ get; set; }
		public MobileAdsManager.AdEvent					OnInterstitialAdLoaded			{ get; set; }
		public MobileAdsManager.AdEvent					OnInterstitialAdFailedToLoad	{ get; set; }
		public MobileAdsManager.AdEvent					OnInterstitialAdShowing			{ get; set; }
		public MobileAdsManager.AdEvent					OnInterstitialAdShown			{ get; set; }
		public MobileAdsManager.AdEvent					OnInterstitialAdClosed			{ get; set; }

		public MobileAdsManager.AdEvent					OnRewardAdLoading				{ get; set; }
		public MobileAdsManager.AdEvent					OnRewardAdLoaded				{ get; set; }
		public MobileAdsManager.AdEvent					OnRewardAdFailedToLoad			{ get; set; }
		public MobileAdsManager.AdEvent					OnRewardAdShowing				{ get; set; }
		public MobileAdsManager.AdEvent					OnRewardAdShown					{ get; set; }
		public MobileAdsManager.AdEvent					OnRewardAdClosed				{ get; set; }
		public MobileAdsManager.RewardAdGrantedEvent	OnRewardAdGranted				{ get; set; }
		...
		/// </summary>
		protected abstract void DoAdsRemoved();
		...
		public bool LoadBannerAd()
		{
			...
			if (!isInitialized)
			{
				Logger.LogError(LogTag, "Cannot show banner, network handler has not been initialized");
				return false;
			}

			if (!bannerAdsEnabled)
			{
				Logger.LogError(LogTag, "Cannot show banner, banner ads have not been selected for this ad network");
				return false;
			}
		...
		public void ShowBannerAd()
		{
			...
			Logger.Log(LogTag, "Showing banner ad");
		...
		public void HideBannerAd()
		{
			...
			Logger.Log(LogTag, "Hiding banner ad");

			if (!isInitialized)
			{
				Logger.LogError(LogTag, "Cannot show/hide banner, network handler has not been initialized");
				return;
			}

			if (!bannerAdsEnabled)
			{
				Logger.LogError(LogTag, "Cannot show/hide banner, banner ads have not been selected for this ad network");
				return;
			}
		...
		public bool LoadInterstitialAd()
		{
			...
			if (!isInitialized)
			{
				Logger.LogError(LogTag, "Cannot pre-load interstitial ad, network handler has not been initialized");
				return false;
			}

			if (!interstitialAdsEnabled)
			{
				Logger.LogError(LogTag, "Cannot pre-load interstitial ad, interstitial ads have not been selected for this ad network");
				return false;
			}

			if (InterstitialAdState != AdState.None)
			{
				Logger.Log(LogTag, "Interstitial ad will not be pre-loaded because the AdState is not None, AdState: " + InterstitialAdState);
				return false;
			}
		...
		public bool ShowInterstitialAd()
		{
			...
			Logger.Log(LogTag, "Showing interstitial ad");

			if (!isInitialized)
			{
				Logger.LogError(LogTag, "Cannot show interstitial ad, network handler has not been initialized");
				return false;
			}

			if (!interstitialAdsEnabled)
			{
				Logger.LogError(LogTag, "Cannot show interstitial ad, interstitial ads have not been selected for this ad network");
				return false;
			}

			if (RewardAdState == AdState.Showing || RewardAdState == AdState.Shown)
			{
				Logger.Log(LogTag, "Interstitial ad will not show because the reward ad is showing");
				return false;
			}
			...
			{
				case AdState.None:
					Logger.Log(LogTag, "Interstitial ad will not show because there is no loaded interstitial ad to show, loading one now");
				...
				case AdState.Loading:
					Logger.Log(LogTag, "Interstitial ad will not show because there is no loaded interstitial ad to show, the interstitial ad is currently being loaded");
					break;
				case AdState.Showing:
					Logger.Log(LogTag, "Interstitial ad is about to show");
					break;
				case AdState.Shown:
					Logger.Log(LogTag, "Interstitial ad is already showing");
					break;
				case AdState.Wait:
					Logger.Log(LogTag, "Interstitial ad will not show because the AdState is set to Wait");
					break;
			}
		...
		public bool LoadRewardAd()
		{
			...
			if (!isInitialized)
			{
				Logger.LogError(LogTag, "Cannot pre-load reward ad, network handler has not been initialized");
				return false;
			}

			if (!rewardAdsEnabled)
			{
				Logger.LogError(LogTag, "Cannot pre-load reward ad, reward ads have not been selected for this ad network");
				return false;
			}

			if (RewardAdState != AdState.None)
			{
				Logger.Log(LogTag, "Reward ad will not be pre-loaded because the AdState is not None, AdState: " + RewardAdState);
				return false;
			}
		...
		public bool ShowRewardAd()
		{
			...
			Logger.Log(LogTag, "Showing reward ad");

			if (!isInitialized)
			{
				Logger.LogError(LogTag, "Cannot show reward ad, network handler has not been initialized");
				return false;
			}

			if (!rewardAdsEnabled)
			{
				Logger.LogError(LogTag, "Cannot show reward ad, reward ads have not been selected for this ad network");
				return false;
			}

			if (InterstitialAdState == AdState.Showing || InterstitialAdState == AdState.Shown)
			{
				Logger.Log(LogTag, "Reward ad will not show because the interstitial ad is showing");
				return false;
			}
			...
			{
				case AdState.None:
					Logger.Log(LogTag, "Reward ad will not show because there is no loaded reward ad to show, loading one now");
				...
				case AdState.Loaded:
					...
					return true;
				case AdState.Loading:
					Logger.Log(LogTag, "Reward ad will not show because there is no loaded reward ad to show, the reward ad is currently being loaded");
					break;
				case AdState.Showing:
					Logger.Log(LogTag, "Reward ad is about to show");
					break;
				case AdState.Shown:
					Logger.Log(LogTag, "Reward ad is already showing");
					break;
				case AdState.Wait:
					Logger.Log(LogTag, "Reward ad will not show because the AdState is set to Wait");
					break;
			}
		...
		protected void NotifyBannerAdLoading()
		{
			...
			Logger.Log(LogTag, "Banner Ad loading");
		...
		protected void NotifyBannerAdLoaded()
		{
			...
			Logger.Log(LogTag, "Banner Ad loaded");
		...
		protected void NotifyBannerAdFailedToLoad(string error = "")
		{
			...
			Logger.LogError(LogTag, "Banner Ad failed to load" + (string.IsNullOrEmpty(error) ? "" : ", error: " + error));
		...
		protected void NotifyBannerAdShown()
		{
			...
			Logger.Log(LogTag, "Banner Ad shown");
		...
		protected void NotifyBannerAdHidden()
		{
			...
			Logger.Log(LogTag, "Banner Ad hidden");
		...
		protected void NotifyInterstitialAdLoading()
		{
			...
			Logger.Log(LogTag, "Interstitial Ad loading");
		...
		protected void NotifyInterstitialAdLoaded()
		{
			...
			Logger.Log(LogTag, "Interstitial Ad loaded");
		...
		protected void NotifyInterstitialAdFailedToLoad(string error = "")
		{
			...
			Logger.LogError(LogTag, "Interstitial Ad failed to load" + (string.IsNullOrEmpty(error) ? "" : ", error: " + error));
		...
		protected void NotifyInterstitialAdShowing()
		{
			...
			Logger.Log(LogTag, "Interstitial Ad showing");
		...
		protected void NotifyInterstitialAdShown()
		{
			...
			Logger.Log(LogTag, "Interstitial Ad shown");
		...
		{
			Logger.Log(LogTag, "Interstitial Ad closed");
		...
		protected void NotifyRewardAdLoading()
		{
			...
			Logger.Log(LogTag, "Reward Ad loading");
		...
		protected void NotifyRewardAdLoaded()
		{
			...
			Logger.Log(LogTag, "Reward Ad loaded");
		...
		protected void NotifyRewardAdFailedToLoad(string error = "")
		{
			...
			Logger.LogError(LogTag, "Reward Ad failed to load" + (string.IsNullOrEmpty(error) ? "" : ", error: " + error));
		...
		protected void NotifyRewardAdShowing()
		{
			...
			Logger.Log(LogTag, "Reward Ad showing");
		...
		protected void NotifyRewardAdShown()
		{
			...
			Logger.Log(LogTag, "Reward Ad shown");
		...
		{
			Logger.Log(LogTag, "Reward Ad closed");
		...
		{
			Logger.Log(LogTag, string.Format("Reward Ad reward granted, rewardId: {0}, rewardAmount: {1}", rewardId, rewardAmount));

			if (OnRewardAdGranted != null)
			{
				OnRewardAdGranted.Invoke(rewardId, rewardAmount);
			}
		}

		private void InvokeEvent(MobileAdsManager.AdEvent adEvent)
		{
			if (adEvent != null)
			{
				adEvent.Invoke();
